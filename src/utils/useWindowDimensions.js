...
const xlargeBreakpoint = (theme) =>
	convertPxToNumber(theme.breakpoints.extraLarge);
...
const xSmallBreakpoint = (theme) =>
	convertPxToNumber(theme.breakpoints.extraSmall);
...
export const getWindowDimensionInfo = (width, height, theme) => ({
	...
	widthBreakpoints: {
		...
		isLargeScreen:
			width >= largeBreakpoint(theme) && width < xlargeBreakpoint(theme),
		isMediumScreen:
			width >= mediumBreakpoint(theme) && width < largeBreakpoint(theme),
		isSmallScreen:
			width >= smallBreakpoint(theme) && width < mediumBreakpoint(theme),
		isSmallestScreen:
			width >= xSmallBreakpoint(theme) && width < smallBreakpoint(theme),
