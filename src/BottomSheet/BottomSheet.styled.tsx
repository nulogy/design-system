...
const OverlayDialog = styled(
	ReachDialogOverlay as React.ComponentType<DialogOverlayProps>,
)({});
...
const SheetDialog = styled(
	ReachDialogContent as React.ComponentType<DialogContentProps>,
)({
	width: "100%",
	display: "flex",
	justifyContent: "center",
