  ...
  return (
    ...
    >
          ...
          <Tabs defaultSelectedIndex={0}>
            <Tab label="Record information">
              <Box py={{extraSmall: "x2", large: "x3"}}>
                <Flex justifyContent="flex-end" mb="x2">
                  <IconicButton icon="edit" onClick={handleEditClick} mr="x1">Edit details</IconicButton>
                </Flex>
                <DescriptionList columns={{ small: 1, medium: 2, large: 3 }}>
                  ...
                  <DescriptionGroup>
                    ...
                    <DescriptionDetails>
                      REC-2024-002 (Production Order), REC-2024-003 (Quality Check), REC-2024-004 (Material Request), REC-2024-005 (Equipment Maintenance), REC-2024-006 (Safety Inspection), REC-2024-007 (Training Record), REC-2024-008 (Inventory Adjustment), REC-2024-009 (Supplier Delivery), REC-2024-010 (Customer Order)
                    </DescriptionDetails>
                  </DescriptionGroup>
                </DescriptionList>
              </Box>
            ...
            <Tab label="Attachments">
              <Box py={{extraSmall: "x2", large: "x4"}}>
                <Flex justifyContent="flex-end" mb="x2">
                  <Flex gap="x2" alignItems="center" mr="x1">
                    <IconicButton icon="add" tooltip="Upload">Upload</IconicButton>
                    <IconicButton icon="filter" tooltip="Filter">Filter</IconicButton>
                    <VerticalDivider />
                    <IconicButton icon="getApp" tooltip="Download">Download</IconicButton>
                    <VerticalDivider />
      ...
      <Sidebar
        ...
        footer={
          <Flex justifyContent="flex-end">
            <QuietButton onClick={handleCloseSidebar} mr="x2">Cancel</QuietButton>
          ...
          <FormSection>
            ...
            <Box pb="x3">
              <FieldLabel labelText="Related records">
                <Textarea
                  value="REC-2024-002 (Production Order), REC-2024-003 (Quality Check), REC-2024-004 (Material Request), REC-2024-005 (Equipment Maintenance), REC-2024-006 (Safety Inspection), REC-2024-007 (Training Record), REC-2024-008 (Inventory Adjustment), REC-2024-009 (Supplier Delivery), REC-2024-010 (Customer Order)"
                />
              </FieldLabel>
            </Box>
          </FormSection>
      ...
      <Sidebar
        ...
        footer={
          <Flex justifyContent="flex-end">
            <QuietButton onClick={handleCloseDetailsSidebar} mr="x2">Cancel</QuietButton>
          ...
          <FormSection>
            ...
            <Box pb="x3">
              <FieldLabel labelText="Date">
                <DatePicker
                  selected={selectedRecord?.date ? new Date(selectedRecord.date) : new Date()}
                />
              </FieldLabel>
            </Box>
          </FormSection>
        ...
        <Box maxWidth="1360px" mx="auto">
          <Card mb="x3" px={{extraSmall: "x3", large: "x6"}} py={{extraSmall: "x2", large: "x4"}} >
              ...
              <Flex justifyContent="space-between" alignItems="center" mb="x2">
                ...
                <IconicButton icon="edit" onClick={handleEditClick}>Edit details</IconicButton>
              </Flex>
