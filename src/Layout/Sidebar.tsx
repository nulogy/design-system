...
function Sidebar({
	...
	top ||= navigationV3
		? theme.space[NAVIGATION_MENU_HEIGHT_STYLED_UNITS]
		: NAVBAR_HEIGHT;
	...
	}, [isOpen, triggerRef?.current?.focus, triggerRef, shouldUpdateFocus]);
			...
			<AnimatedBox
				...
				width={
					typeof selectedWidth === "string"
						? { default: "100%", small: selectedWidth }
						: selectedWidth
				}
				zIndex={zIndex}
			...
			>
				...
				>
					<Flex flexDirection="column" gap="x1">
						...
						{renderHelpText
							? renderHelpText()
							: helpText && <Text color="midGrey">{helpText}</Text>}
					</Flex>
				</Flex>
				<Flex
					p={p}
