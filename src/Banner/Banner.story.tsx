...
export const WithCallToAction = () => (
	<Banner title="Link all your accounts" isCloseable>
		Nulogy Digital Quality Inspections now allows users to access all their
		different accounts using a single email.
		<Box mt="x2">
...
export const AboveTheNavbar = () => (
	<>
		<Banner title="Action required">
			We have detected unauthorized access attempts on your account. Please
...
export const BellowTheHeader = () => (
	<>
		...
		<Header />
		<Banner type="warning">
			<strong>Page refresh required</strong> To obtain the most recent data,{" "}
