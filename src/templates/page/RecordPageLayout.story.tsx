...
export const FullWidth = () => {
  ...
  return (
    <ApplicationFrame navBar={<Navigation {...menuData} />}>
      <Page
            ...
            <Tab label="Record details">
              <Box py={{ extraSmall: "x2", large: "x3" }}>
                ...
                <Table
                  ...
                  compact
                />
                <Card mt="x3" px={{ extraSmall: "x3", large: "x6" }} py={{ extraSmall: "x2", large: "x4" }}>
                  <Heading3 mb="x2">Additional Information</Heading3>
                  <Text>This is additional information about the record details.</Text>
                </Card>
              </Box>
            </Tab>
