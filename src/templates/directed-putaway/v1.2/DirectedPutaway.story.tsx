...
export default {
  title: "Templates/directed-putaway/v1.2",
  parameters: {
    layout: "fullscreen",
  },
} as Meta;
...
export const Default = () => {
  ...
  const handlePalletSubmit = (e: React.FormEvent) => {
    ...
    if (mode === "drop off") {
      ...
      // Pallet is valid - automatically add to in-transit list
      setPalletValidationError(null);
                ...
                {(mode === "pick up" || (mode === "drop off" && pickedUpPallets.length > 0)) && (
                  <Form onSubmit={handlePalletSubmit}>
                    <FormSection>
                      ...
                      <Box pb="x1">
                        <Flex gap="x1" alignItems="flex-start">
                          <Box flex="1">
                          ...
                          {mode === "pick up" && (
                            <Box style={{ minWidth: "160px", paddingTop: "38px" }}>
                              <Select
                                options={[
                              ...
                              />
                              <Box style={{ height: "20px", minHeight: "20px" }} />
                            </Box>
                          )}
                        </Flex>
                      </Box>
