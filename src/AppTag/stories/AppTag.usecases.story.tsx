		...
		return (
			<Flex flexDirection="column" gap="x2">
				<Flex flexDirection="column" gap="x1">
					...
					<Text fontSize="sm">
						These examples show the <Code>Link</Code> component used with the{" "}
						<Code>forApp</Code> prop. See the{" "}
						<Link href="/?path=/story/components-link--with-app-tag">
							With AppTag
						</Link>{" "}
				...
				example: (
					<InlineFlex alignItems="center" gap="half">
						...
						<TruncatedText fontSize="small" color="red">
							Transaction failed because the supplier did not provide the
