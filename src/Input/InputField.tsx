...
import { type CSSObject, styled, useTheme } from "styled-components";
				...
				<Flex alignItems="flex-start">
					...
					<InputWrapper maxWidth={inputWidth}>
						...
						<StyledInput
							paddingLeft={
								iconLeft
									? `calc(${theme.space[iconLeftSize]} + ${theme.space.x1_5})`
									: theme.space.x1
							}
							paddingRight={
								iconRight
									? `calc(${theme.space[iconRightSize]} + ${theme.space.x1_5})`
									: theme.space.x1
							}
							aria-invalid={error}
...
type StyledInputProps = Omit<InputFieldProps, "htmlSize" | "size"> & {
	variant: ComponentVariant;
} & SpaceProps;
