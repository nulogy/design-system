...
export const poliRows = [
  {
    ...
    customerLotCode:
      "LOT-2024-001-EXTREMELY-LONG-CUSTOMER-LOT-CODE-THAT-WILL-TRIGGER-TEXT-TRUNCATION-IN-THE-TABLE-CELL-TO-DEMONSTRATE-THE-TRUNCATEDTEXT-COMPONENT-WORKING-PROPERLY-WITH-ELLIPSIS-AND-TOOLTIP-FUNCTIONALITY",
    supplierLotCode:
      "SUP-LOT-001-EXTREMELY-LONG-SUPPLIER-LOT-CODE-THAT-WILL-TRIGGER-TEXT-TRUNCATION-IN-THE-TABLE-CELL-TO-DEMONSTRATE-THE-TRUNCATEDTEXT-COMPONENT-WORKING-PROPERLY-WITH-ELLIPSIS-AND-TOOLTIP-FUNCTIONALITY",
  ...
  },
  {
    ...
    customerLotCode:
      "LOT-2024-002-EXTREMELY-LONG-CUSTOMER-LOT-CODE-THAT-WILL-TRIGGER-TEXT-TRUNCATION-IN-THE-TABLE-CELL-TO-DEMONSTRATE-THE-TRUNCATEDTEXT-COMPONENT-WORKING-PROPERLY-WITH-ELLIPSIS-AND-TOOLTIP-FUNCTIONALITY",
    supplierLotCode: "",
