...
export const poliRows = [
  {
    ...
    customerLotCode: "LOT-2024-001-EXTREMELY-LONG-CUSTOMER-LOT-CODE-THAT-WILL-TRIGGER-TEXT-TRUNCATION-IN-THE-TABLE-CELL-TO-DEMONSTRATE-THE-TRUNCATEDTEXT-COMPONENT-WORKING-PROPERLY-WITH-ELLIPSIS-AND-TOOLTIP-FUNCTIONALITY",
    supplierLotCode: "SUP-LOT-001-EXTREMELY-LONG-SUPPLIER-LOT-CODE-THAT-WILL-TRIGGER-TEXT-TRUNCATION-IN-THE-TABLE-CELL-TO-DEMONSTRATE-THE-TRUNCATEDTEXT-COMPONENT-WORKING-PROPERLY-WITH-ELLIPSIS-AND-TOOLTIP-FUNCTIONALITY",
  ...
  },
  {
    ...
    customerLotCode: "LOT-2024-002-EXTREMELY-LONG-CUSTOMER-LOT-CODE-THAT-WILL-TRIGGER-TEXT-TRUNCATION-IN-THE-TABLE-CELL-TO-DEMONSTRATE-THE-TRUNCATEDTEXT-COMPONENT-WORKING-PROPERLY-WITH-ELLIPSIS-AND-TOOLTIP-FUNCTIONALITY",
    supplierLotCode: "",
  ...
  },
  {
    ...
    poLineItemNumber: "PLI-006",
    supplierPoLineItemNumber: "SPLI-006",
    createdOn: "2024-01-20",
    customer: "Tech Solutions Inc.",
    customerItemCode: "ITEM-006",
    customerItemDescription: "Advanced Circuit Board Assembly",
    customerItemCodeAndDescription: "ITEM-006 – Advanced Circuit Board Assembly",
    supplierItemCode: "TSI-006",
    priority: "1 - High",
    ...
    supplierLotCode: "TSI-LOT-006",
    expiryDate: "2025-01-20",
    bomRevisionAndReleaseDate: "Rev 1.0 – 2024-01-15",
    materialsAvailabilityDate: "2024-01-25",
    productionStartDate: "2024-01-30",
    canRunNow: "0",
    canRunProductionStartDate: "0",
    nextProductionDate: "2024-02-05",
    closeProductionNote: "",
    ...
    shipTo: "Tech Solutions Inc. Distribution",
    shippedQuantity: "0",
    receivedQuantity: "0",
  },
  {
    ...
    poLineItemNumber: "PLI-007",
    supplierPoLineItemNumber: "SPLI-007",
    createdOn: "2024-01-22",
    customer: "Automotive Parts Co.",
    customerItemCode: "ITEM-007",
    customerItemDescription: "Brake System Components",
    customerItemCodeAndDescription: "ITEM-007 – Brake System Components",
    supplierItemCode: "APC-007",
    priority: "2 - Medium",
    itemOrderType: "Standard",
    quantity: "1200",
    uom: "sets",
    ...
    customerLotCode: "",
    supplierLotCode: "APC-LOT-007",
    expiryDate: "2025-01-22",
    bomRevisionAndReleaseDate: "Rev 2.1 – 2024-01-18",
    materialsAvailabilityDate: "2024-01-28",
    productionStartDate: "2024-02-01",
    canRunNow: "0",
    canRunProductionStartDate: "0",
    nextProductionDate: "2024-02-08",
    closeProductionNote: "",
    carryOverSentTo: "",
    needByDate: "2024-02-15",
    shipTo: "Automotive Parts Co. Warehouse",
    shippedQuantity: "0",
    receivedQuantity: "0",
  },
  {
    ...
    poLineItemNumber: "PLI-008",
    supplierPoLineItemNumber: "SPLI-008",
    createdOn: "2024-01-25",
    customer: "Medical Devices Ltd.",
    customerItemCode: "ITEM-008",
    customerItemDescription: "Surgical Instrument Set",
    customerItemCodeAndDescription: "ITEM-008 – Surgical Instrument Set",
    supplierItemCode: "MDL-008",
    priority: "1 - High",
    itemOrderType: "Standard",
    quantity: "200",
    uom: "sets",
    ...
    supplierLotCode: "MDL-LOT-008",
    expiryDate: "2025-01-25",
    bomRevisionAndReleaseDate: "Rev 3.0 – 2024-01-20",
    materialsAvailabilityDate: "2024-02-01",
    productionStartDate: "2024-02-05",
    canRunNow: "0",
    canRunProductionStartDate: "0",
    nextProductionDate: "2024-02-12",
    closeProductionNote: "",
    carryOverSentTo: "",
    needByDate: "2024-02-20",
    shipTo: "Medical Devices Ltd. Facility",
    shippedQuantity: "0",
    receivedQuantity: "0",
  },
];
