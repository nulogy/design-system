      ...
      <Sidebar
        ...
        helpText={
          <Flex alignItems="center" gap="x1" flexWrap="wrap">
            ...
            <Text>Active</Text>
            <Text as="span">•</Text>
            <StatusIndicator type="quiet">Supplier material owned</StatusIndicator>
          </Flex>
        }
      >
              ...
              <Box>
                <Select
                  ...
                  options={[
                    ...
                    { value: "Supplier", label: "Supplier material owned" },
                    { value: "Customer", label: "Customer material owned" },
