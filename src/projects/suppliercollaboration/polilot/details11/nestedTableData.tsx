...
export const createNestedTableData = (consumptionTableColumns: any) => {
  const nestedTableData1 = [
    {
      ...
      expandedContent: () => (
        <ConsumptionReport
          ...
          materials={[]}
          parentData={{ date: "2025-Feb-12", actualQuantity: "0 cases" }}
        />
      ),
    },
    {
  ...
  const nestedTableData4 = [
    {
      ...
      expandedContent: () => (
        <ConsumptionReport
          consumptionTableColumns={consumptionTableColumns}
          materials={[]}
          parentData={{ date: "2025-Aug-08", actualQuantity: "0 cases" }}
        />
      ),
    },
  ];
  ...
  const nestedTableData6 = [
    ...
    },
    {
      ...
      expandedContent: () => (
        <ConsumptionReport consumptionTableColumns={consumptionTableColumns} materials={materialsData6B} />
      ),
    },
  ];
  ...
  const nestedTableData7 = [
    {
      ...
      expandedContent: () => (
        <ConsumptionReport materials={materialsData7A} consumptionTableColumns={consumptionTableColumns} />
      ),
    },
    {
      id: "7-2",
  ...
  const nestedTableData8 = [
    {
      ...
      expandedContent: () => (
        <ConsumptionReport materials={materialsData1} consumptionTableColumns={consumptionTableColumns} />
      ),
    },
  ];
