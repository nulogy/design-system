...
export const Loading = () => {
  ...
  const actualProductionReportColumns = [
    ...
    },
    {
      ...
      width: "180px",
      cellRenderer: ({ row }: { row: any }) => {
        // If actualQuantity is a React element (Skeleton), return it directly
        if (React.isValidElement(row.actualQuantity)) {
    ...
    },
    {
      ...
      cellRenderer: ({ row }: { row: any }) => {
        ...
        // If expiry date is a React element (skeleton), return it as-is
    ...
    },
    {
      ...
      width: "auto",
      cellRenderer: ({ row }: { row: any }) => {
        // If note is a React element (Skeleton), return it directly
  ...
  // Helper function to generate random skeleton widths
  ...
  return (
    <>
      ...
      <style>{`
        /* Additional skeleton wave animation styles */
        .skeleton-wave {
          position: absolute;
          top: 0;
          left: 0;
      ...
      `}</style>
      <style>{`
        .actual-production-edit-table thead {
