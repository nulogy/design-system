    ...
    <div style={{ border: "1px solid #e4e7eb", borderRadius: "8px", padding: "16px" }}>
      <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
        ...
        <div style={{ display: "flex", gap: "16px", padding: "8px 0", borderBottom: "1px solid #e4e7eb" }}>
          <div style={{ width: "120px" }}><div style={{ fontSize: "14px", fontWeight: "bold" }}>Date</div></div>
          <div style={{ width: "100px" }}><div style={{ fontSize: "14px", fontWeight: "bold" }}>Quantity</div></div>
          <div style={{ width: "120px" }}><div style={{ fontSize: "14px", fontWeight: "bold" }}>Lot Code</div></div>
          <div style={{ width: "100px" }}><div style={{ fontSize: "14px", fontWeight: "bold" }}>Status</div></div>
        </div>
