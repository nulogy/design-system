...
export default {
  title: "Projects/Supplier Collaboration/Lot traceability/POLI details V2",
};
...
export const V2 = () => {
  ...
  const [generalHistoryLogFilter, setGeneralHistoryLogFilter] = useState("All");
    ...
    <ApplicationFrame navBar={<BrandedNavBar menuData={{ primaryMenu, secondaryMenu }} />}>
      ...
      <Page>
        ...
        <Tabs selectedIndex={selectedIndex} onTabClick={(e, index) => setSelectedIndex(index)}>
          ...
          <Tab label="Production record history log">
            {/* Header */}
            <Box mt="x4">
            ...
            {/* Log - Only Production record entries */}
            <Flex flexDirection="column">
