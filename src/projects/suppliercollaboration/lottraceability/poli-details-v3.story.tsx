...
export default {
  title: "Projects/Supplier Collaboration/Lot traceability/POLI details V3",
};
...
export const V3 = () => {
  ...
  const [historyLogView, setHistoryLogView] = useState("General");
          ...
          <Tab label="History log">
            ...
            <Box mt="x4" mb="x2">
              <Flex justifyContent="flex-end">
                <Switcher selected={historyLogView} onChange={(value) => setHistoryLogView(value)}>
                  <Switch value="General">General</Switch>
            ...
            {/* Log */}
            {historyLogView === "General" ? (
              <Box mt="x4">
                <Text>Old design</Text>
              </Box>
            ) : (
              <>
                {/* Header - only shown for Production record */}
                <Box mt="x4">
                ...
                <Flex flexDirection="column">
                  {/* Entry 1: Production Record for January 29, 2025 */}
                  ...
                  {/* Entry 2: Actual Production Record 001 */}
                  <Flex flexDirection="column" gap="x1_5" maxWidth="1280px" mx="x1" pt="x1_5" pb="x2_5">
                    <Box pt="x1">
                      <Flex fontSize="small" lineHeight="smallCompact" alignItems="center" gap="half">
                        <Box as="span" color="black" fontWeight="bold">
                  ...
                  {/* Entry 3: Actual Production Record 002 */}
                  <Flex flexDirection="column" gap="x1_5" maxWidth="1280px" mx="x1" pt="x1_5" pb="x2_5">
                    <Box pt="x1">
                      <Flex fontSize="small" lineHeight="smallCompact" alignItems="center" gap="half">
                        <Box as="span" color="black" fontWeight="bold">
                  ...
                  {/* Entry 4: Subcomponent Consumption Record 001 */}
                  <Flex flexDirection="column" gap="x1_5" maxWidth="1280px" mx="x1" pt="x1_5" pb="x2_5">
                    <Box pt="x1">
                      <Flex fontSize="small" lineHeight="smallCompact" alignItems="center" gap="half">
                        <Box as="span" color="black" fontWeight="bold">
                  ...
                  {/* Entry 5: Subcomponent Consumption Record 002 */}
                  <Flex flexDirection="column" gap="x1_5" maxWidth="1280px" mx="x1" pt="x1_5" pb="x2_5">
                    <Box pt="x1">
                      <Flex fontSize="small" lineHeight="smallCompact" alignItems="center" gap="half">
                        <Box as="span" color="black" fontWeight="bold">
                  ...
                  {/* Entry 6: Subcomponent Consumption Record 004 */}
                  <Flex flexDirection="column" gap="x1_5" maxWidth="1280px" mx="x1" pt="x1_5" pb="x2_5">
                    <Box pt="x1">
                      <Flex fontSize="small" lineHeight="smallCompact" alignItems="center" gap="half">
                        <Box as="span" color="black" fontWeight="bold">
                  ...
                  {/* Entry 7: Production Record for February 1, 2025 */}
                  <Flex flexDirection="column" gap="x1_5" maxWidth="1280px" mx="x1" pt="x1_5" pb="x2_5">
                    <Box pt="x1">
                      <Flex fontSize="small" lineHeight="smallCompact" alignItems="center" gap="half">
                        <Box as="span" color="black" fontWeight="bold">
                  ...
                  {/* Entry 8: Actual Production Record 003 */}
                  <Flex flexDirection="column" gap="x1_5" maxWidth="1280px" mx="x1" pt="x1_5" pb="x2_5">
                    <Box pt="x1">
                      <Flex fontSize="small" lineHeight="smallCompact" alignItems="center" gap="half">
                        <Box as="span" color="black" fontWeight="bold">
                  ...
                  {/* Entry 9: Subcomponent Consumption Record 005 */}
                  <Flex flexDirection="column" gap="x1_5" maxWidth="1280px" mx="x1" pt="x1_5" pb="x2_5">
                    <Box pt="x1">
                      <Flex fontSize="small" lineHeight="smallCompact" alignItems="center" gap="half">
                        <Box as="span" color="black" fontWeight="bold">
