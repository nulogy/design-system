...
const OrgSettingsComponent = () => {
  ...
  const [enforceExpiryDateTracking, setEnforceExpiryDateTracking] = useState(false);
              ...
              <Box mb="x2">
                ...
                <Box mb="x2">
                  <Checkbox
                    ...
                    onChange={(e) => setEnforceLotTracking(e.target.checked)}
                    labelText="Enforce lot tracking"
                  />
                  <Text ml="x3" mt="quarter" color="midGrey" fontSize="small">
                    Require lot tracking for all ...
                  </Text>
                  {enforceLotTracking && (
                    <Box mb="x2" ml="x3" mt="x1">
                      <Checkbox
                        checked={enableLotItemLevelOverrides}
                        onChange={(e) => setEnableLotItemLevelOverrides(e.target.checked)}
                ...
                <Box mb="x2">
                  <Checkbox
                    ...
                    onChange={(e) => setEnforceExpiryDateTracking(e.target.checked)}
                    labelText="Enforce expiry date tracking"
                  />
                  <Text ml="x3" mt="quarter" color="midGrey" fontSize="small">
                    Require expiry date tracking for all ...
                  </Text>
                  {enforceExpiryDateTracking && (
                    <Box mb="x2" ml="x3" mt="x1">
                      <Checkbox
                        checked={enableExpiryDateItemLevelOverrides}
                        onChange={(e) => setEnableExpiryDateItemLevelOverrides(e.target.checked)}
                        labelText="Enable item-level overrides"
                      />
                      <Text ml="x3" mt="quarter" color="midGrey" fontSize="small">
                        TBD
