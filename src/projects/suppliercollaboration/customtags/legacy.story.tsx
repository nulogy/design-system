...
export default {
  title: "Projects/Supplier Collaboration/Custom tags/POLI/V1/Default",
  parameters: {
    layout: "fullscreen",
  },
};
                  ...
                  {(() => {
                    const tags = [
                      ...
                      },
                      {
                        ...
                        type: userState.role === "supplier" ? "quiet" : "warning",
                      },
                      {
                        label: "Rush order",
                        type: "quiet",
                    ...
                    const sortedTags = [...tags].sort((a, b) => getTagTypeOrder(a.type) - getTagTypeOrder(b.type));
