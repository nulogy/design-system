...
// Helper component to render a header with specific configuration
...
// Helper component to render a Details section with specific configuration
...
export const DetailsSectionExamples = () => {
  const [filters, setFilters] = useState({
    viewedAs: "all" as "all" | "customer" | "supplier",
