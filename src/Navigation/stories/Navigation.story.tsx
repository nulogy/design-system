	...
	return (
		<ApplicationFrame
			navBar={
				<Navigation
					primaryNavigation={[
						{ key: "dashboard", label: "Dashboard", type: "link" },
					]}
					secondaryNavigation={[
						{
							key: "settings",
							...
							items: [
								{
									...
									label: "BOMs",
									type: "link",
									props: { href: "/admin/bom_visualizer" },
								},
								{
									key: "other",
									label: "Other Page",
									type: "link",
									props: { href: "/admin/other_page" },
								},
							],
						},
					]}
				...
				>
					<Flex flexDirection="column" gap="x2">
						...
						<Text fontSize="small" color="darkGrey">
							The navigation will transition to desktop when the viewport is
							wider than <Code>{breakpoint}</Code>.
						</Text>
						<Text fontSize="small" color="darkGrey">
							You can also use any valid key from the{" "}
							<a href="/?path=/story/tokens--breakpoints">theme breakpoints</a>{" "}
			...
			navBar={
				<>
					<Banner title="Action required">
						We have detected unauthorized access attempts on your account.
