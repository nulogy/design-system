		...
		<ApplicationFrame navBar={children}>
			<Page>
				...
				<Text mb="x2" color="darkGrey" fontSize="small">
					...
					{breakpoints[NAVIGATION_DEFAULT_BREAKPOINT_THEME_KEY]}) to observe the
...
export const DefaultBehavior = () => (
	<StoryLayout
		description={
			<>
				Default behavior: Items without <Code>mobileVisibility</Code> set will
				appear in the mobile navigation menu.
			</>
		}
	>
		<Navigation
...
export const ItemInNavigationBar = () => (
	<StoryLayout
		description={
			<>
				Items with <Code>mobileVisibility: &quot;navigationBar&quot;</Code> will
				appear directly in the mobile navigation bar.
			</>
		}
	>
		<Navigation
...
export const ItemInNavigationMenu = () => (
	<StoryLayout
		description={
			<>
				Items with <Code>mobileVisibility: &quot;navigationMenu&quot;</Code>{" "}
				will appear inside the collapsible mobile menu. This is also the default
				behavior if the prop is not set.
			</>
		}
	>
		<Navigation
...
export const ItemHiddenOnMobile = () => (
	<StoryLayout
		description={
			<>
				Items with <Code>mobileVisibility: &quot;hidden&quot;</Code> will not be
...
export const MixedVisibility = () => (
	<StoryLayout
		description={
			<>
				A mix of items with different <Code>mobileVisibility</Code> settings to
				demonstrate various behaviors simultaneously.
			</>
		}
	>
		<Navigation
