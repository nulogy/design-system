					...
					>
						<Flex flexDirection="column" gap="x2">
							<Text fontSize="small" color="darkGrey">
								In this example, the <strong>Dashboard</strong>,{" "}
								<strong>Inspector</strong>, and <strong>Reports</strong> are
								links, and the <strong>Sheets</strong> and{" "}
								<strong>Forms</strong> are buttons.
							</Text>
							<Text fontSize="small" color="darkGrey">
								The <strong>Search</strong> and <strong>Settings</strong>{" "}
								buttons are secondary navigation items.
							</Text>
							<Text fontSize="small" color="darkGrey">
								Everything that can be rendered in the{" "}
								<Code>primaryNavigation</Code> (left part of the navigation) can
								also be rendered in the <Code>secondaryNavigation</Code> (right
								part of the navigation), and vice versa.
							</Text>
						</Flex>
					</Sidebar>
					<Box flex={1} />
...
export const CustomMenuItems = () => {
	return (
							...
							items: [
								{
									...
									render: () => {
										return (
											<Text color="darkGrey">I am custom submenu item 1</Text>
										);
									},
								},
								{
							...
							render: ({ withinSubMenu, withinMobileNav, level }) => (
								<>
									...
									>
										...
										<pre>
											<Text>
												withinSubMenu: {withinSubMenu ? "true" : "false"}
											</Text>
											<Text>
												withinMobileNav: {withinMobileNav ? "true" : "false"}
											</Text>
					...
					secondaryNavigation={[
						{
							...
							render: () => {
								return (
									<Input
										placeholder="Custom menu item too!"
										iconLeft="search"
									/>
								);
							},
		...
		>
			<Page fullHeight>
				<Alert type="warning">
					Custom menu items should be used sparingly. When used, make sure they
					remain accessible and use styles that are inline with the rest of the
					navigation. The render function gives you access to{" "}
					<Code>withinSubMenu</Code>, <Code>withinMobileNav</Code>, and{" "}
					<Code>level</Code> to style and position the rendered items properly.
