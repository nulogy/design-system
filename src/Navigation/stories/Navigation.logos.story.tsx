...
import { Flex, type NulogyAppName, Text } from "../..";
...
export const WithANulogyApplicationName = () => {
	const [application, setApplication] = useState<NulogyAppName>(
		...
		>
			<Page fullHeight>
				...
				>
					...
					>
						<Radio
							value="supplier-collaboration"
							labelText="Supplier Collaboration"
						/>
						<Radio value="smart-factory" labelText="Smart Factory" />
						<Radio
							value="digital-quality-inspection"
							labelText="Digital Quality Inspection"
						/>
						<Radio
							value="production-scheduling"
							labelText="Production Scheduling"
						/>
...
export const SecondaryLogo = () => {
	return (
		<BrowserRouter>
			<Navigation
				secondaryLogo={
					<CustomLogoThree style={{ width: "auto", height: 32 }} />
				}
			/>
		</BrowserRouter>
	);
...
export const WithoutPassingAPrimaryLogo = () => {
	return (
		<ApplicationFrame navBar={<Navigation />}>
			<Page fullHeight>
				<Alert type="warning">
					If the primary logo is not passed, the Nulogy logo without an
					application name will be used with a standard anchor tag with an{" "}
...
export const WithoutAPrimaryLogo = () => {
	return (
		<ApplicationFrame navBar={<Navigation primaryLogo={<Fragment />} />}>
			<Page fullHeight>
				<Alert type="danger">
					This is not a recommended usage of the Navigation component.
				</Alert>
			</Page>
		</ApplicationFrame>
	);
...
export const WithACustomPrimaryLogo = () => {
	return (
		<ApplicationFrame
			navBar={
				<Navigation
					primaryLogo={<CustomLogo2 style={{ width: "auto", height: 24 }} />}
				/>
			}
		>
			<Page fullHeight>
				...
				<Page fullHeight>
					<Flex flexDirection="column" gap="x2">
						<Text>
							...
							<Code>width</Code> / <Code>height</Code> on the passed{" "}
							<Code>ReactNode</Code> to prevent overflow, or using the{" "}
							<Code>NavigationLogo</Code> helper.
						</Text>
						<Text>
							<Code>NavigationLogo</Code> component constrains logos to maximum{" "}
							<Code>184px</Code> width and <Code>36px</Code> height by default
							to prevent overflow in the Navigation.
						</Text>

						<Text>
							You can adjust this by passing <Code>maxWidth</Code> and{" "}
							<Code>maxHeight</Code> props to the <Code>NavigationLogo</Code>{" "}
							component.
						</Text>
					</Flex>
				</Page>
