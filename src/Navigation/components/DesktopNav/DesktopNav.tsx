...
} from "../shared/NavigationMenuItem";
	...
	return (
		<NavigationMenuRoot>
			...
			<NavigationMenuList ref={secondaryMenuRef}>
				...
				{secondaryNavigation.length > 0 && userMenuExists && (
					<VerticalDivider />
				)}
					...
					<RadixNavigationMenu.Item>
						...
						{hasUserMenuContent && (
							<NavigationMenuContent
								...
								pb={userMenu.menuItems?.length ? "x1" : "none"}
							...
							>
								...
								{(userMenu.controls ||
									...
									>
										{userMenu.controls && (
											<Box p="x2">
												{userMenu.controls({ withinMobileNav: false })}
											</Box>
										)}
										{userMenu.controls &&
											userMenu.menuItems &&
