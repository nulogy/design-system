...
export const ComponentVariantContext =
	createContext<ComponentVariantContextValue>(undefined);

export default function ComponentVariantContextProvider({
	variant,
	children,
}: ComponentVariantContextValue) {
	return (
		<ComponentVariantContext.Provider value={{ variant: variant }}>
			{children}
