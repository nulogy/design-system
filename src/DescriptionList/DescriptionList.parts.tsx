...
export const DescriptionList = styled.dl(({ theme }) => {
	const { fontSize, lineHeight, density, columns, groupMinWidth } =
...
export const DescriptionGroup = styled.div<{
	...
	const { descriptionTermMaxWidth, layout, showDivider, autoLayoutBreakpoint } =
		useDescriptionListContext();
...
export const DescriptionTerm = styled.dt(({ theme }) => {
	const { showDivider, layout, density, autoLayoutBreakpoint } =
		useDescriptionListContext();
...
export const DescriptionDetails = styled.dd(({ theme }) => {
	const { autoLayoutBreakpoint, showDivider, density, layout } =
		useDescriptionListContext();
