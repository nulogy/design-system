...
const DescriptionListContext = createContext<
	DescriptionListContextProps | undefined
>(undefined);
...
export const DescriptionListProvider = ({
	...
	<DescriptionListContext.Provider value={contextProps}>
		{children}
...
export const useDescriptionListContext = () => {
	...
	if (!context) {
		throw new Error(
			"useDescriptionListContext must be used within a DescriptionListProvider",
		);
	}
	return context;
};
