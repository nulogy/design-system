		...
		return (
			<Flex flexDirection="column" gap="x2">
				<Flex flexDirection="column" gap="x1">
					...
					<Text fontSize="sm">
						Automatically switches between <Code>stacked</Code> and{" "}
						<Code>inline</Code> layouts based on the specified container width.
						Default breakpoint is set to <Code>640px</Code>.
					</Text>
