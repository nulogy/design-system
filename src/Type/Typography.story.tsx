...
export const Article = () => {
	return (
		<>
			...
			<Heading2>
				Donec leo felis vitae nisl vestibulum vitae nisl vestibulum vitae nisl
				vestibulum
			</Heading2>
			<Text mb="x3">
				...
				malesuada. Nam luctus blandit dignissim. Mauris eu odio tristique, lorem
				quis, lobortis nulla. Interdum et malesuada fames ac ante ipsum primis
				in faucibus. Nunc quis lacus felis. Ut convallis rhoncus orci. Maecenas
				sit amet leo dui. Integer semper porta dignissim.
			</Text>
			<Heading3>
				Long Title that Hopefully wraps. Maybe now? How About Now? Now? Now?
				Now? Now? Now? Now?
			</Heading3>
			<Text mb="x3">
			...
			<Text mb="x3">
				Nam luctus blandit dignissim. Mauris eu odio tristique, lorem quis,
				lobortis nulla. Interdum et malesuada fames ac ante ipsum primis in
				faucibus. Nunc quis lacus felis. Ut convallis rhoncus orci. Maecenas sit
				amet leo dui. Integer semper porta dignissim.
			</Text>
			<Text mb="x3">
				Nunc id arcu sagittis, volutpat sit amet, accumsan diam. Pellentesque
				luctus, nulla a ornare semper, dui mollis nisi, vel lacinia neque velit
				eget sapien. Etiam sodales dolor, vel dictum libero cursus ac. Nam
				vulputate tempor mauris vel. Nam tristique metus et dignissim pretium.
			...
			<Text mb="x3" fontSize="small" lineHeight="smallTextBase">
				...
				sit amet, accumsan diam. Pellentesque luctus, nulla a ornare semper, dui
				mollis nisi, vel lacinia neque velit eget sapien. Etiam sodales dolor,
				vel dictum libero cursus ac. Nam vulputate tempor mauris vel. Nam
				tristique metus et dignissim pretium. Aliquam erat volutpat.
			</Text>
			<Heading3>
				This is small text (14px) with small line height (16px). Reserved for
				buttons, inputs ...
			</Heading3>
			...
			<Heading3>
				This is smaller text (12px) with smaller line height (16px). Reserved
				for buttons, inputs ...
			</Heading3>
		...
		<Flex flexDirection="column" gap="x5">
			...
			<Flex flexDirection="column">
				...
				<Text fontSize="heading1" lineHeight="heading1">
					heading1 ({theme.fontSizes.heading1}) / heading1 (
					{theme.lineHeights.heading1})
				</Text>
				<Text fontSize="heading2" lineHeight="heading2">
					heading2 ({theme.fontSizes.heading2}) / heading2 (
					{theme.lineHeights.heading2})
				</Text>
				<Text fontSize="heading3" lineHeight="heading3">
					heading3 ({theme.fontSizes.heading3}) / heading3 (
					{theme.lineHeights.heading3})
				</Text>
				<Text fontSize="heading4" lineHeight="heading4">
					heading4 ({theme.fontSizes.heading4}) / heading4 (
			...
			<Flex flexDirection="column">
				<Flex flexDirection="column" mb="x3">
					<Heading2 compact>
						Experimental interface text (font-size / line-height)
					</Heading2>
					<Text fontSize="smallest">
						These theme values are experimental and may be modified or removed
						in future updates.
					</Text>
				</Flex>
				...
				<Text fontSize="xxs" lineHeight="baseRelaxed">
					xxs ({theme.fontSizes.xxs}) / baseRelaxed (
					{theme.lineHeights.baseRelaxed})
				</Text>
				...
				<Text fontSize="sm" lineHeight="baseRelaxed">
					sm ({theme.fontSizes.sm}) / baseRelaxed (
					{theme.lineHeights.baseRelaxed})
				</Text>
				...
				<Text fontSize="md" lineHeight="baseRelaxed">
					md ({theme.fontSizes.md}) / baseRelaxed (
					{theme.lineHeights.baseRelaxed})
				</Text>
				...
				<Text fontSize="lg" lineHeight="baseRelaxed">
					lg ({theme.fontSizes.lg}) / baseRelaxed (
					{theme.lineHeights.baseRelaxed})
				</Text>
				...
				<Text fontSize="xl" lineHeight="baseRelaxed">
					xl ({theme.fontSizes.xl}) / baseRelaxed (
					{theme.lineHeights.baseRelaxed})
				</Text>
				...
				<Text fontSize="xxl" lineHeight="baseRelaxed">
					xxl ({theme.fontSizes.xxl}) / baseRelaxed (
					{theme.lineHeights.baseRelaxed})
				</Text>
			</Flex>
		</Flex>
