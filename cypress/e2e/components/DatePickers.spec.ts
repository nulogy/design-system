describe("Datepicker", () => {
  ...
  describe("DatePickers", () => {
    describe("DatePicker", () => {
      beforeEach(() => {
        cy.renderFromStorybook("datepickers-datepicker--default");
      });
      ...
      describe("With min and max date", () => {
        beforeEach(() => {
          cy.renderFromStorybook("datepickers-datepicker--with-min-and-max-date");
        });
      ...
      describe("Default", () => {
        ...
        describe("has the correct defaults", () => {
          it("shows the correct placeholder text", () => {
            getDateInputComponent().should("have.attr", "placeholder", "W52 - Dec 31, 2023");
          });
