      ...
      return (
        <React.Fragment>
          <path
            ...
            fill={ disabled ? theme.colors.lightGrey : theme.colors.darkBlue }
          />
          <circle
            cx="44" cy="20" r="16"
        ...
        <React.Fragment>
          <path
            d="M36,20c0-8.8-7.2-16-16-16S4,11.2,4,20s7.2,16,16,16S36,28.8,36,20z M60,20
                c0-8.8-7.2-16-16-16H31.9c4.9,3.7,8.1,9.5,8.1,16s-3.2,12.3-8.1,16H44C52.8,36,60,28.8,60,
                20z M64,20c0,11-9,20-20,20H20C9,40,0,31,0,20S9,0,20,0h24C55,0,64,9,64,20z"
            fill={ disabled ? theme.colors.lightGrey : theme.colors.darkBlue }
          />
          <path
            d="M36,20c0-8.8-7.2-16-16-16S4,11.2,4,20s7.2,16,16,16S36,28.8,36,20z M60,20
