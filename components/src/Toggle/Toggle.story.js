...
storiesOf("Toggle", module)
  ...
  .add("Toggle set to defaultToggled", () => <Toggle labelText="Toggle" defaultToggled />)
  .add("Toggle set to disabled", () => (
    <>
      <Toggle labelText="Toggle" disabled onText="on" offText="off" />
      <Toggle id="toggle-2" disabled onText="on" offText="off" defaultToggled labelText="Toggle" />
    </>
  ))
  .add("With custom id", () => <Toggle id="my-custom-id" labelText="Toggle" onText="on" offText="off" />)
  .add("With text", () => <Toggle labelText="Toggle" onText="on" offText="off" />)
  .add("With long text", () => (
    <Toggle
      labelText="Toggle"
      defaultToggled
