...
storiesOf('Buttons / Button', module)
  ...
  .add('With an icon', () => <Button onClick={action('clicked')}><Icon name="add" /></Button>)
  .add('With an icon and text', () => <Button onClick={action('clicked')}><Icon name="edit" /> Edit this thing</Button>)
