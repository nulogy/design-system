...
storiesOf('Buttons / Primary Button', module)
  ...
  .add('With an icon', () => <Button type="submit" onClick={action('clicked')}><Icon name="add" /></Button>)
  .add('With an icon and text', () => <Button type="submit" onClick={action('clicked')}><Icon name="edit" />Edit this thing</Button>)
...
storiesOf('Buttons / Approval Button', module)
  ...
  .add('With an icon', () => <ApprovalButton onClick={action('clicked')}><Icon name="save" /></ApprovalButton>)
  .add('With an icon and text', () => <ApprovalButton onClick={action('clicked')}><Icon name="edit" />Edit this thing</ApprovalButton>)
  ...
  .add('With an icon', () => <ApprovalButton type="submit" onClick={action('clicked')}><Icon name="cancel" /></ApprovalButton>)
  .add('With an icon and text', () => <ApprovalButton type="submit" onClick={action('clicked')}><Icon name="edit" />Edit this thing</ApprovalButton>)
...
storiesOf('Buttons / Danger Button', module)
  ...
  .add('With an icon', () => <DangerButton onClick={action('clicked')}><Icon name="delete" /></DangerButton>)
  .add('With an icon and text', () => <DangerButton onClick={action('clicked')}><Icon name="edit" />Edit this thing</DangerButton>)
...
storiesOf('Buttons / Primary Danger Button', module)
  ...
  .add('With an icon', () => <DangerButton type="submit" onClick={action('clicked')}><Icon name="save" /></DangerButton>)
  .add('With an icon and text', () => <DangerButton type="submit" onClick={action('clicked')}><Icon name="edit" />Edit this thing</DangerButton>)
...
storiesOf('Buttons / Quiet Button', module)
  ...
  .add('With an icon', () => <QuietButton onClick={action('clicked')}><Icon name="delete" /></QuietButton>)
  .add('With an icon and text', () => <QuietButton onClick={action('clicked')}><Icon name="edit" />Edit this thing</QuietButton>)
  ...
  .add('With an icon', () => <LinkButton onClick={action('clicked')}><Icon name="delete" /></LinkButton>)
  .add('With an icon and text', () => <LinkButton onClick={action('clicked')}><Icon name="edit" />Edit this thing</LinkButton>)
...
storiesOf('Buttons / Link Button without underline', module)
  ...
  .add('With an icon', () => <LinkButton underline={false} onClick={action('clicked')}><Icon name="save" /></LinkButton>)
  .add('With an icon and text', () => <LinkButton underline={false} onClick={action('clicked')}><Icon name="edit" />Edit this thing</LinkButton>)
...
storiesOf('Buttons / Icons', module)
  ...
  .add('FAIL: With an icon at the end', () => <Button onClick={action('clicked')}>Delete<Icon name="delete" /></Button>)
  .add('Small, with an icon', () => <Button size="small" onClick={action('clicked')}><Icon name="save" /></Button>)
  .add('Small, with an icon and text', () => <Button size="small" onClick={action('clicked')}><Icon name="save" /> Edit this thing</Button>)
  .add('Small, with an icon and long text', () => <Button size="small" onClick={action('clicked')}><Icon name="delete" /> Edit this thing Etiam id viverra ligula. Praesent suscipit egestas nulla, vel fermentum felis viverra id. Cras scelerisque ante tincidunt magna faucibus dapibus. Proin dui felis, tempor facilisis nisl ut, elementum finibus tortor. Curabitur euismod, elit vitae ullamcorper pharetra, est felis imperdiet sem, eget porta sem erat condimentum nibh. Etiam pellentesque blandit tincidunt. Integer dapibus erat non orci mattis, et eleifend erat viverra.</Button>)
  .add('Large, with an icon', () => <Button size="large" onClick={action('clicked')}><Icon name="save" /></Button>)
  .add('Large, with an icon and text', () => <Button size="large" onClick={action('clicked')}><Icon name="save" /> Edit this thing</Button>)
  .add('Large, with an icon and long text', () => <Button size="large" onClick={action('clicked')}><Icon name="delete" /> Edit this thing Etiam id viverra ligula. Praesent suscipit egestas nulla, vel fermentum felis viverra id. Cras scelerisque ante tincidunt magna faucibus dapibus. Proin dui felis, tempor facilisis nisl ut, elementum finibus tortor. Curabitur euismod, elit vitae ullamcorper pharetra, est felis imperdiet sem, eget porta sem erat condimentum nibh. Etiam pellentesque blandit tincidunt. Integer dapibus erat non orci mattis, et eleifend erat viverra.</Button>)
