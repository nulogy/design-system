    ...
    <Layout>
        ...
        <DocSection>
            <Flex mb={4}>
                ...
                <Box width={4/6}>
                    <Text mb={0}><Text inline fontWeight={2} mb={0}>Buttons</Text> are used for actions that do not require any special emphasis and cover most cases.</Text>
                </Box>
            </Flex>
            <Flex mb={4}>
                <Flex width={2/6}  justifyContent='center' alignItems='center'>
                ...
                <Box width={4/6}>
                    <Text mb={0}><Text inline fontWeight={2} mb={0}>Primary Buttons</Text> are used for the main action in a particular context. There is usually not more than one primary button per screen and not all of the screens require a Primary button.</Text>
                </Box>
            </Flex>
            <Flex mb={4}>
                <Flex width={2/6} justifyContent='center' alignItems='center'>
                ...
                <Box width={4/6}>
                    <Text mb={0}><Text inline fontWeight={2} mb={0}>Danger Buttons</Text> are used for destructive actions such as deleting. They are most likely to appear in confirmation dialogs.</Text>
                </Box>
            </Flex>
            <Flex mb={4}>
                <Flex width={2/6} justifyContent='center' alignItems='center'>
                ...
                <Box width={4/6}>
                    <Text mb={0}><Text inline fontWeight={2} mb={0}>Quiet Buttons</Text> are used for less important actions such as “Cancel” or actions that are not directly related to the context of the page (e.g Learn more …). Quiet buttons are often paired with a Primary button.</Text>
                </Box>
            </Flex>
            <Flex mb={4}>
              ...
              <Box width={4/6}>
                <Text mb={0}><Text inline fontWeight={2} mb={0}>Iconic Buttons</Text> are used for universally understood actions that can effectively be represented using icon.</Text>
              </Box>
            </Flex>
        </DocSection>
