    ...
    actions: [
      {
        ...
        templateFile: "components/template/component.hbs"
      },
      {
        type: "add",
        path: "components/src/{{name}}/index.js",
        templateFile: "components/template/index.hbs"
      },
      {
        type: "add",
        path: "components/src/{{name}}/{{name}}.story.js",
        templateFile: "components/template/component.story.hbs"
      },
      {
        type: "modify",
        path: "components/src/index.js",
        pattern: /$/,
        templateFile: "components/template/index-js-injection.txt"
      },
      function(data) {
